...
}`;class te extends D{constructor(){super();i(this,"_updateHandler");i(this,"_layoutHandler");i(this,"_c",0);this._updateHandler=this._update.bind(this),p.instance.add(this._updateHandler),this._layoutHandler=this._resize.bind(this),w.instance.add(this._layoutHandler)}init(){}dispose(){p.instance.remove(this._updateHandler),this._updateHandler=null,w.instance.remove(this._layoutHandler),this._layoutHandler=null}_update(){this._c++}_resize(){}_getUni(e){return e.material.uniforms}_setUni(e,t,n){const s=this._getUni(e);s[t].value=n}_call(e){e!=null&&e()}}class ne extends te{constructor(e){super();i(this,"_id",0);i(this,"_mesh");i(this,"_imgSize",0);i(this,"_isLoaded",!1);i(this,"_sample",[]);i(this,"onLoaded");this._id=e.id,this.onLoaded=e.onLoaded;const t=new Image;t.src=h.instance.PATH_IMG+"sample-"+this._id+".png",t.onload=()=>{const n=document.createElement("canvas"),s=t.width;n.width=n.height=s,this._imgSize=s;const r=n.getContext("2d");r.drawImage(t,0,0),t.style.display="none";const d=r.getImageData(0,0,n.width,n.height).data;for(let u=0;u<d.length;u+=4){const l=~~(u/4),m=~~(l%n.width),v=~~(l/n.width),S=d[u+3],x=1;S>0&&this._sample.push({pos:new V((m-s*.5)*x,(v-s*.5)*-1*x,0)})}console.log(this._sample.length),this._isLoaded=!0,this._call(this.onLoaded)}}get isLoaded(){return this._isLoaded}get sample(){return this._sample}makeMesh(e,t){this._mesh=new k(this.getGeo(e,t),new X({vertexShader:Z,fragmentShader:ee,transparent:!0,depthTest:!1,uniforms:{alpha:{value:0},size:{value:2},time:{value:0},yure:{value:0},show:{value:0},hide:{value:0},color:{value:new T}}})),this.add(this._mesh)}getGeo(e,t){const n=this._sample.length,s=new j,r=new Float32Array(n*3),o=new Float32Array(n*3),d=new Float32Array(n*3),u=new Float32Array(n*3);let l=0,m=0;for(;m<n;){const v=this._sample[m].pos,S=a.instance.randomArr(e).pos,x=a.instance.randomArr(t).pos;r[l*3+0]=v.x,r[l*3+1]=v.y,r[l*3+2]=0,o[l*3+0]=S.x,o[l*3+1]=S.y,o[l*3+2]=0,d[l*3+0]=x.x,d[l*3+1]=x.y,d[l*3+2]=0;const I=v.x-this._imgSize*.5,R=v.y-this._imgSize*0;u[l*3+0]=a.instance.map(m,0,1,0,n-1),u[l*3+1]=Math.sqrt(I*I+R*R),u[l*3+2]=1,l++,m++}return s.setAttribute("position",new C(r,3)),s.setAttribute("prevPosition",new C(o,3)),s.setAttribute("nextPosition",new C(d,3)),s.setAttribute("info",new C(u,3)),s.computeBoundingSphere(),s}_update(){if(super._update(),this._mesh!=null){const e=f.instance.sw(),t=f.instance.sh(),n=f.instance.r(Math.min(e,t)/this._imgSize*2.5);this._mesh.scale.set(n,n,1);const s=_.instance.ang,o=360/h.instance.ITEM_NUM,d=a.instance.map(s,0,1,this._id*(o*.75),this._id*o+o),u=a.instance.map(d,0,1,0,.45),l=a.instance.map(d,0,1,.55,1);let m=1-u+l;this._setUni(this._mesh,"yure",m),this._setUni(this._mesh,"size",4),this._setUni(this._mesh,"time",this._c),this._setUni(this._mesh,"show",u),this._setUni(this._mesh,"hide",l),this._setUni(this._mesh,"color",new T(16777215))}}}class ie extends J{constructor(e){super(e);i(this,"_con");i(this,"_colors",[]);i(this,"_val",0);i(this,"_oldAng",-1);i(this,"_rotCnt",0);i(this,"_item",[]);var t,n;this._makeColors(),a.instance.shuffle(this._colors),this._con=new D,this.mainScene.add(this._con),!h.instance.FLG_TEST&&window.DeviceOrientationEvent?(t=document.querySelector(".l-btn"))==null||t.addEventListener("click",()=>{window.DeviceOrientationEvent.requestPermission().then(s=>{var r;s=="granted"&&(window.addEventListener("deviceorientation",o=>{this._oldAng!=-1?this._oldAng=this._val:this._oldAng=Number(o.alpha),this._val=Number(o.alpha),_.instance.debug.innerHTML="alpha:"+this._val,this._oldAng-this._val>300&&this._rotCnt++,this._oldAng-this._val<-300&&this._rotCnt--},!0),(r=document.querySelector(".l-btn"))==null||r.classList.add("-none"))})}):(n=document.querySelector(".l-btn"))==null||n.classList.add("-none");for(let s=0;s<h.instance.ITEM_NUM;s++){const r=new ne({id:s,color:this._colors,onLoaded:()=>{this._eLoaded()}});this._con.add(r),this._item.push(r)}this._resize()}_eLoaded(){let e=0;this._item.forEach(t=>{t.isLoaded&&e++}),e>=this._item.length&&this._makeMesh()}_makeMesh(){this._item.forEach((e,t)=>{const n=t==0?this._item[this._item.length-1]:this._item[t-1],s=t==this._item.length-1?this._item[0]:this._item[t+1];e.makeMesh(n.sample,s.sample)})}_update(){super._update(),this._con.position.y=f.instance.screenOffsetY()*-1,h.instance.FLG_TEST?(this._oldAng=this._val,this._val=_.instance.mesh.ang.value,this._val=this._val%360,this._oldAng-this._val>300&&this._rotCnt++,_.instance.ang=_.instance.mesh.ang.value,_.instance.debug.innerHTML=String(_.instance.ang)):_.instance.ang=this._val+this._rotCnt*360,this.isNowRenderFrame()&&this._render()}_render(){this.renderer.setClearColor(0,1),this.renderer.render(this.mainScene,this.camera)}isNowRenderFrame(){return this.isRender}_resize(e=!0){super._resize();const t=f.instance.sw(),n=f.instance.sh();if((h.instance.IS_SP||h.instance.IS_TAB)&&t==this.renderSize.width&&this.renderSize.height*2>n)return;this.renderSize.width=t,this.renderSize.height=n,this.updateCamera(this.camera,t,n);let s=window.devicePixelRatio||1;this.renderer.setPixelRatio(s),this.renderer.setSize(t,n),this.renderer.clear(),e&&this._render()}_makeColors(){this._colors=[];const e=new L(a.instance.random(0,1),a.instance.random(0,1),a.instance.random(0,1)),t=new L(a.instance.random(0,1),a.instance.random(0,1),a.instance.random(0,1)),n=new L(a.instance.random(0,1),a.instance.random(0,1),a.instance.random(0,1));for(let s=0;s<20;s++){const r=e.clone();this._colors.push(r.lerp(t,a.instance.random(0,1)));const o=t.clone();this._colors.push(o.lerp(n,a.instance.random(0,1)));const d=n.clone();this._colors.push(d.lerp(e,a.instance.random(0,1)))}}}new ie({el:document.querySelector("#js-con")});
